...
#print()
#print('shape of mo matrices', np.shape(mf.mo_coeff), np.shape(mf.mo_occ) )
#print()
...
#
print('from hcore', np.shape(dm), np.shape(mf.get_hcore()) )
print('from hcore', np.einsum('ij,ij', mf.get_hcore()[0], dm[0]))
#print(dir(mf))
