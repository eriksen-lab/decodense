...
print('')
print('')
vpp_fft = pbctools.get_pp_fftdf(mydf)
print('all close vpp?', np.allclose(vpp, vpp_fft, atol=1e-08) )
...
#print('all close vloc2?', np.allclose(np.einsum('zab->ab', vloc2), vloc2_v2, atol=1e-54) )
#print('all close vloc2_at?', np.allclose(vloc2, vloc2_v2_at, atol=1e-14) )
#print('')
#print('vnl, vnl_v2, vnl_v2_at shapes', np.shape(vnl), np.shape(vnl_v2), np.shape(vnl_v2_at) )
#print('all close vnl?', np.allclose(np.einsum('zab->ab', vnl), vnl_v2, atol=1e-54) )
#print('all close vnl_at?', np.allclose(vnl, vnl_v2_at, atol=1e-14) )
#print('')
...
#print('sum, all close vpp_atomic?', np.allclose(vpp_atomic, vloc1_v2_at+vloc2_v2_at+vnl_v2_at, atol=1e-10) )
