...
vnuc_gdf_at = pbctools.get_nuc_atomic_df(mydf)
vnuc_gdf = np.einsum('zab->ab', vnuc_gdf_at)
print('all close pyscf vnuc and vnuc_gdf?', np.allclose(vnuc, vnuc_gdf, atol=1e-08) )
